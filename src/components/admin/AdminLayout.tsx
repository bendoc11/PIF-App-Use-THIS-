...
import { BookOpen, Users, Shield, MessageSquare, ArrowLeft, Star, Zap, UserCircle, Upload, Search, Mail, Handshake } from "lucide-react";
...
const adminNavItems = [
  ...
  { title: "Partners", url: "/admin/partners", icon: Handshake, roles: ["admin"] },
